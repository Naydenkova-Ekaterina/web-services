...
public class App {
    ...
    public static void main(String[] args) {
        ...
        //Lab 3
        try {
            printList(getStudentsByName(client, ""));
        } catch (Exception e) {
    ...
    private static void createStudent(Client client) {
        ...
        webResource = webResource.queryParam("studentGroupNumber", "");
    ...
    private static void updateStudent(Client client) {
        ...
        webResource = webResource.queryParam("studentAge", String.valueOf(188));
    ...
    private static void deleteStudent(Client client) {
        ...
        webResource = webResource.queryParam("id", String.valueOf(100));
