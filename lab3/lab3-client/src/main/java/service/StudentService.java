 ...
 * 
 */
@WebServiceClient(name = "StudentService", targetNamespace = "http://service/", wsdlLocation = "http://localhost:8081/StudentService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName STUDENTSERVICE_QNAME = new QName("http://service/", "StudentService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/StudentService?wsdl");
    ...
    public StudentWebService getStudentWebServicePort() {
        return super.getPort(new QName("http://service/", "StudentWebServicePort"), StudentWebService.class);
    }
    ...
    public StudentWebService getStudentWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "StudentWebServicePort"), StudentWebService.class, features);
    }
