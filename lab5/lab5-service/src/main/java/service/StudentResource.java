...
public class StudentResource {
    ...
    @POST
    @Path("/createStudent")
    public Response createStudent(@QueryParam("studentName") String name, @QueryParam("studentSurname") String surname, @QueryParam("studentAge") int age, @QueryParam("studentGroupNumber") String groupNumber, @QueryParam("studentFaculty") String faculty) {
    ...
    @PUT
    @Path("/updateStudent")
    public Response updateStudent(@QueryParam("id") Long id, @QueryParam("studentName") String name, @QueryParam("studentSurname") String surname, @QueryParam("studentAge") int age, @QueryParam("studentGroupNumber") String groupNumber, @QueryParam("studentFaculty") String faculty) {
        PostgreSqlDAO dao = new PostgreSqlDAO();
        return Response
                .status(Response.Status.OK)
